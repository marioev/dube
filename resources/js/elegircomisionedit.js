...
function inicio(){
    ...
    var convocatoria_id  = document.getElementById('estaconvocatoria_id').value;
    mostrar_convocatoria(gestion_id, convocatoria_id);
}
/* muestra las convocatorias de una gestion */
function mostrar_convocatoria(gestion_id, convocatoria_id){
    var controlador = "";
    ...
    $.ajax({url: controlador,
           ...
           success:function(respuesta){
                ...
                if (registros != null){
                    ...
                    var selected = "";
                    for (var i = 0; i < n ; i++){
                        if(registros[i]["convocatoria_id"] == convocatoria_id){
                            selected = "selected";
                        }else{
                            selected = "";
                        }
