    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Modificar Comision Postulante</h3>
            </div>
            <?php echo form_open('comision_postulante/edit/'.$comision_postulante['comisionpost_id']); ?>
                <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select name="postulante_id" class="form-control">
                                    ...
                                    {
                                        $selected = ($postulante['postulante_id'] == $comision_postulante['postulante_id']) ? ' selected="selected"' : "";
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <select name="comision_id" class="form-control">
                                    ...
                                    {
                                        $selected = ($comision['comision_id'] == $comision_postulante['comision_id']) ? ' selected="selected"' : "";
