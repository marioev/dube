                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo site_url('resources/images/administrativo/'.$session_data['thumb']);  ?>" class="user-image" alt="">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="<?php echo site_url('resources/images/administrativo/'.$session_data['usuario_imagen']);?>" class="img-circle" alt="">
                                        <p>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo site_url('resources/images/administrativo/'.$session_data['thumb']);?>" class="img-circle" alt="User Image">
                        </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            ...
                            <ul class="treeview-menu">
                                ...
                                ?>
                                <li>
                                    <a href="<?php echo site_url('reporte/rep_postulante');?>"><i class="fa fa-users"></i>Postulantes</a>
                                </li>
                                <?php }
                                if($rolusuario[45-1]['rolusuario_asignado'] == 1){
                                ?>
