                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input type="text" name="convocatoria_titulo" value="<?php echo $this->input->post('convocatoria_titulo'); ?>" class="form-control" id="convocatoria_titulo" autofocus autocomplete="off" required onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                            </div>
                        </div>
                        <div class="col-md-12">
