                ...
                <div class="row clearfix">
                    ...
                    <?php if($con_convocatoria == "1"){ ?>
                        ...
                        foreach($all_requisito as $requisito){
                            $checked = "";
                            $esta_observacion = "";
                            foreach($all_formulario as $requi){
                                if($requi["convoreq_id"] == $requisito["convoreq_id"]){
                                    if($requi["estado_id"] == 7){
                                        $checked = "checked";
                                    }
                                    $esta_observacion = $requi["formulario_observacion"];
                                    break;
                                }
                            }
                            ?>
                        <div class="col-md-6 text-left">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="formulario_observacion<?php echo $requisito["requisito_id"]; ?>" value="<?php echo ($this->input->post('formulario_observacion') ? $this->input->post('formulario_observacion') : $esta_observacion); ?>" class="form-control" id="formulario_observacion<?php echo $requisito["requisito_id"]; ?>" />
                            </div>
                        </div>
                        <?php
                        }
