    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Añadir Solicitud de Unidades</h3>
            </div>
            <?php echo form_open('solicitud_unidad/add'); ?>
          	<div class="box-body">
                    <div class="row clearfix">
                        <div class="col-md-6">
                            <label for="solicitud_unidad" class="control-label">Solicitud Unidad</label>
                            <div class="form-group">
                                <input type="text" name="solicitud_unidad" value="<?php echo $this->input->post('solicitud_unidad'); ?>" class="form-control" id="solicitud_unidad" required autofocus autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="solicitud_cantidad_becarios" value="<?php echo $this->input->post('solicitud_cantidad_becarios'); ?>" class="form-control" id="solicitud_cantidad_becarios" />
                            </div>
                        </div>
                        <div class="col-md-6">
