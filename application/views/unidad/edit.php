            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="unidad_dependencia" value="<?php echo ($this->input->post('unidad_dependencia') ? $this->input->post('unidad_dependencia') : $unidad['unidad_dependencia']); ?>" class="form-control" id="unidad_dependencia" autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                    </div>
                    </div>
                    <div class="col-md-6">
                        <label for="unidad_responsable" class="control-label">Responsable</label>
                        <div class="form-group">
                            <input type="text" name="unidad_responsable" value="<?php echo ($this->input->post('unidad_responsable') ? $this->input->post('unidad_responsable') : $unidad['unidad_responsable']); ?>" class="form-control" id="unidad_responsable" autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                        </div>
                    </div>
                </div>
            </div>
