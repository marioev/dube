...
<script src="<?php echo base_url('resources/js/reporte_spostulante.js'); ?>" type="text/javascript"></script>
...
<div class="cuerpo">
    ...
    <div class="columna_central">
        <center>
            <h3 class="box-title"><u>REPORTE DE POSTULANTES A UNIDADES</u></h3>
