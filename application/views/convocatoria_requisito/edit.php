    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Convocatoria Requisito Edit</h3>
            </div>
			<?php echo form_open('convocatoria_requisito/edit/'.$convocatoria_requisito['convoreq_id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="requisito_id" class="form-control">
								...
								{
									$selected = ($requisito['requisito_id'] == $convocatoria_requisito['requisito_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="convocatoria_id" class="form-control">
								...
								{
									$selected = ($convocatoria['convocatoria_id'] == $convocatoria_requisito['convocatoria_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="beca_id" class="form-control">
								...
								{
									$selected = ($beca['beca_id'] == $convocatoria_requisito['beca_id']) ? ' selected="selected"' : "";
