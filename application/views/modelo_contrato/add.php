      	...
      	<div class="box box-info">
            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte1" class="control-label"><span class="text-danger">*</span>Parte 1</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte2" class="control-label"><span class="text-danger">*</span>Parte 2</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte3" class="control-label"><span class="text-danger">*</span>Parte 3</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte4" class="control-label"><span class="text-danger">*</span>Parte 4</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte5" class="control-label"><span class="text-danger">*</span>Parte 5</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte6" class="control-label"><span class="text-danger">*</span>Parte 6</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte7" class="control-label"><span class="text-danger">*</span>Parte 7</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte8" class="control-label"><span class="text-danger">*</span>Parte 8</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte9" class="control-label"><span class="text-danger">*</span>Parte 9</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte10" class="control-label"><span class="text-danger">*</span>Parte 10</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="modeloc_parte11" class="control-label"><span class="text-danger">*</span>Parte 11</label>
                        <div class="form-group">
