<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('cargo/edit/'.$cargo['cargo_id']); ?>
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        <label for="cargo_nombre" class="control-label"><span class="text-danger">*</span>Nombre</label>
                        <div class="form-group">
                            <input type="text" name="cargo_nombre" value="<?php echo ($this->input->post('cargo_nombre') ? $this->input->post('cargo_nombre') : $cargo['cargo_nombre']); ?>" class="form-control" id="cargo_nombre" required autofocus autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
